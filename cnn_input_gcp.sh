...
# Start profiler in the background
sudo ./CUPTI_receiver 0 1 0 pcie_total_data_received > cnn_input_received_640.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 1 0 pcie_total_data_received > cnn_input_received_768.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 1 0 pcie_total_data_received > cnn_input_received_896.csv &
