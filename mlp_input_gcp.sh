...
sudo ./CUPTI_receiver 0 1 0 pcie_total_data_received > single_iteration_mlp_input_received_128.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 1 0 pcie_total_data_received > single_iteration_mlp_input_received_256.csv &
