...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > mlp_input_received_192.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > mlp_input_received_320.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > mlp_input_received_384.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > mlp_input_received_448.csv &
