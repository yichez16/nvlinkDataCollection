...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > mlp_input_received_2048.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > mlp_input_received_4096.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > mlp_input_received_8192.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > cnn_input_received_2048.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > cnn_input_received_4096.csv &
...
# Start profiler in the background
sudo ./CUPTI_receiver 0 0 0 pcie_total_data_received > cnn_input_received_8192.csv &
