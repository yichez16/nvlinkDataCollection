...
int main(int argc, char **argv) {
    ...
    remote = atoi(argv[2]);
    profile = atoi(argv[3]);
    // char *ctr_num1 = argv[4];
    // char *ctr_num2 = argv[5];
    // char *ctr_num3 = argv[6];
    // char *ctr_num4 = argv[7];
    sizeElement = atoi(argv[4]);  // Transfer size is 256 bytes = 1 nvlink packet， 4 Bytes for size of int
